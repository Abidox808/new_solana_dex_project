            ...
            <ul>
              ...
              <li>
                <Link
                  ...
                  className={location.pathname === '/trading-dashboard' ? 'active' : ''}
                >
                  Trading Dashboard
                </Link>
              </li>
              <li>
                <Link
                  to="/token-sniper"
                  className={location.pathname === '/token-sniper' ? 'active' : ''}
                >
                  Token Sniper
                </Link>
              </li>
              <li>
                <Link to="/ecosystem" className={`main-link ${isEcosystemPage ? 'active' : ''}`}>
                  Ecosystem
                </Link>
              </li>
            </ul>
              ...
              <nav>
                <ul>
                  ...
                  <li>
                    <Link
                      to="/limit-order"
                      className={location.pathname === '/limit-order' ? 'active' : ''}
                    >
                      Limit
                    </Link>
                  </li>
                  ...
                  <li>
                    <Link to="/perps" className={location.pathname === '/perps' ? 'active' : ''}>
                      Perps
                    </Link>
                  </li>
                  <li>
                    <Link
                      to="/yield-farming"
                      className={location.pathname === '/yield-farming' ? 'active' : ''}
                    >
                      CRPT Presale
                    </Link>
                  </li>*/}
            ...
            <nav>
              <ul>
                <li>
                  <Link
                    to="/ecosystem/gaming"
                    className={location.pathname === '/ecosystem/gaming' ? 'active' : ''}
                  >
                ...
                <li>
                  <Link
                    to="/ecosystem/lending"
                    className={location.pathname === '/ecosystem/lending' ? 'active' : ''}
                  >
                    <span className="icon">💸</span> Lending
                  </Link>
                </li>
                <li>
                  <Link
                    to="/ecosystem/music"
                    className={location.pathname === '/ecosystem/music' ? 'active' : ''}
                  >
                ...
                <li>
                  <Link
                    to="/ecosystem/staking"
                    className={location.pathname === '/ecosystem/staking' ? 'active' : ''}
                  >
                ...
                <li>
                  <Link
                    ...
                    className={location.pathname === '/ecosystem/liquidity' ? 'active' : ''}
                  >
                    <span className="icon">💧</span> Liquidity
                  </Link>
                </li>
              </ul>
            </nav>
